...
<body>
    <div style="background-image:url('../Images/Open_Book.png'); background-size:cover; position:relative; top:000px; right:-200px; width:1550px; height:930px; float:left; background-repeat:no-repeat;">
        <div style="position:relative; top:150px; right:-200px; width:500px; height:650px; float:left; background-color:rgb(20, 50, 100); padding:30px;">
        ...
        <div style="position:relative; top:150px; right:195px; width:500px; height:650px; float:right; background-color:rgb(20, 50, 100); padding:30px;">
            <h1 style="color:white; text-align:center">
                The Editor
            </h1>
            <p>
