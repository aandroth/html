...
<body>
    <div style="background-image:url('../Images/FS_Screens/iOS_Videos_Viewing.png'); background-size:cover; position:relative; top:-20px; right:-100px; width:700px; height:900px; float:left; background-repeat:no-repeat;">
