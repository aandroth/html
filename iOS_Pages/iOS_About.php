...
<body>
    <div class="iOS_Active" style="background-image:url('../Images/FS_Screens/iOS_About.png');">
        <div id="Back" class="iOS_Back" onmouseup="goBack()" onmouseover="mouseOver('Back')" onmouseout="mouseOut('Back')" style="top:21.5%; left:13.1%; width:15%; height:4%;">
    ...
    <div class="iOS_Info_Box" style="position:relative;">
        ...
        <p class="info_Box_Text">
            The About page is a description of Frontier Scientists, and the people behind it. 
            ...
            You can read this in full at the <a href="https://frontierscientists.com/about/">About Page</a>.
        </p>
    </div>    
    <!-- Menu buttons -->
