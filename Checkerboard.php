...
<body>
    <div style="background-image:url('../Images/checker_board.png'); background-size:cover; position:relative; top:100px; right:-100px; width:700px; height:750px; float:left; background-repeat:no-repeat;">
    </div>
    <div style="position:relative; top:50px; right:100px; width:900px; height:800px; float:right; background-color:rgb(20, 50, 100); padding:30px;">
        ...
        <p>
            ...
            At first their moves were very much random and stupid, but by having the winners copied with minor random tweaks to their node wieghts,
